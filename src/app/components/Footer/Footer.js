    ...
    <footer className="xl:px-52 lg:px-40 font-PlusJakarta bg-gray-100 dark:bg-[#383838] py-10 px-6 mt-10 w-[1,216px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-gray-300 pt-8">
        ...
        <div className="dark:text-white">
          <h3 className="font-semibold text-[18px] mb-4 text-boldTextcolor dark:text-white">
            About
          </h3>
          ...
          <p className="text-grey dark:text-white text-[16px] font-normal">
            <span className="font-semibold text-boldTextcolor dark:text-white">
              Email
            </span>{" "}
            : info@jstemplate.net
          </p>
        ...
        <div className="flex justify-evenly">
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-[18px] text-boldTextcolor dark:text-white mb-4">
              Quick Link
            </h3>
